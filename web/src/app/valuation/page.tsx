              ...
              <div className="space-y-12">
                ...
                <div className="grid gap-8">
                   {[
                     ...
                     <div key={item.title} className="group relative flex gap-6 sm:gap-8 p-8 sm:p-10 rounded-[2.5rem] border border-[#D4AF37]/20 bg-white hover:bg-[#022c22] shadow-[0_20px_50px_rgba(0,0,0,0.06)] hover:shadow-[0_40px_80px_rgba(2,44,34,0.3)] transition-all duration-1000 overflow-hidden cursor-default">
