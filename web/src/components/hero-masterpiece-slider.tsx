              ...
              <div className="max-w-md">
                ...
                >
                  <div className="flex items-center gap-4 mb-5">
                    <div className="h-[2px] w-8 bg-[#1B3A6B]" />
                    <span className="text-[0.6rem] md:text-[0.7rem] font-black uppercase tracking-[0.5em] text-[#1B3A6B] drop-shadow-[0_1px_3px_rgba(0,0,0,0.8)]">
                  ...
                  <h1 className="text-2xl md:text-3xl lg:text-4xl font-black text-white leading-tight mb-4 tracking-tighter">
                    {slides[currentIndex].title.split(' ').map((word, i) => (
                      <span key={i} className={i === slides[currentIndex].title.split(' ').length - 1 ? "text-[#1B3A6B] drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)]" : ""}>
                        {word}{' '}
                      </span>
                    ))}
                  </h1>
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex flex-col">
                      <span className="text-[0.55rem] font-bold text-[#1B3A6B] uppercase tracking-widest leading-none mb-1 drop-shadow-[0_1px_3px_rgba(0,0,0,0.8)]">
