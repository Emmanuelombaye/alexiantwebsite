      ...
      {show && (
        ...
        >
          ...
          <a
            ...
            className="group relative flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-[#046A38] to-[#035930] text-white shadow-[0_15px_40px_rgba(4,106,56,0.28)] transition-transform hover:scale-110 active:scale-95"
            aria-label="Chat on WhatsApp"
          >
            {/* Pulsing ring */}
            <div className="absolute inset-0 rounded-full bg-[#046A38] animate-ping opacity-20 group-hover:opacity-40" />
